...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Muhammad Nouman Alam | Portfolio";
            $("Profile22").attr("href", "assets/images/Profile22.jpeg");
        }
        else {
            document.title = "Muhammad Nouman Alam";
        }
    });
...
var typed = new Typed(".typing-text", {
    strings: ["Data Scientist", "FinTech Engineer"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showSkills() {
  const skills = [
    ...
    { name: "MS Word", icon: "https://img.icons8.com/color/48/000000/ms-word.png" },
